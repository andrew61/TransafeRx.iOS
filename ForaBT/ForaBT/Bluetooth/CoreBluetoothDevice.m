...
- (void)foraBpReadData{
    char const Command_ReadDevice[] = {0x51,   0x24,  0x00,    0x00,    0x00,   0x00,  0xA3,   0x18};
...
- (void)foraBpEnterCommData{
    char const Command_EnterCommunication[] = {0x51,   0x54,  0x00,    0x00,    0x00,   0x00,  0xA3,   0x48};
...
- (void)foraBpTakeBPData{
    char const Command_TakeBP[] = {0x51,   0x43,  0x00,    0x00,    0x01,   0x01,  0xA3,   0x39};
